...
export default function PythonRoadmap() {
  const steps = [
    ...
    {
      title: "Phase 3: Built-in Libraries (Python \"STL\")",
      phase: "phase3",
    ...
    },
    {
      ...
      items: [
        { label: "OOP (Classes & Objects)", slug: "oop" },
      ...
      <main className="max-w-4xl mx-auto px-6 pt-20 pb-32">
        ...
        >
          <h1 className="text-5xl md:text-7xl font-black tracking-tighter mb-6">
            Python <span className="text-red-600">ROADMAP_</span>
          </h1>
          <section className="mb-7">
            <ActivityHeatmap storageKey="python-activity" />
          </section>
          <p className="text-neutral-400 text-lg max-w-2xl leading-relaxed">
            The fastest language for prototyping and problem solving. This structured path takes you from
            basic syntax to mastering Python's powerful built-in libraries.
          </p>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {step.items.map((item, i) => (
                  <Link
                    key={i}
                    href={`/langroadmap/python/${step.phase}/${item.slug}`}
